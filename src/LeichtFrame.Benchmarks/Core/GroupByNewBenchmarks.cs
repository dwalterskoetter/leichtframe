...
namespace LeichtFrame.Benchmarks
{
    ...
    public class GroupByNewBenchmarks
    {
        ...
        // =========================================================
        // SCENARIO A: DENSE INT (Histogram vs DirectAddressing)
        // =========================================================
        ...
        public long DuckDB_A_Stream()
        {
            ...
            while (reader.Read())
            {
                // Force data access to include marshalling costs
        ...
        public long LF_A_Stream()
        {
            ...
            {
                // Access data via RowView struct
        ...
        [Benchmark(Description = "DuckDB: Dense Int (Mat)")]
        public List<object[]> DuckDB_A_Mat()
        {
            ...
            while (reader.Read())
            {
                // Force materialization into managed heap objects
                result.Add(new object[] { reader.GetValue(0), reader.GetValue(1) });
            }
            return result;
        }

        [Benchmark(Description = "LF: Dense Int (Mat)")]
        ...
        [Benchmark(Description = "DuckDB: LowCard String (Mat)")]
        ...
        [Benchmark(Description = "LF: LowCard String (Mat)")]
        ...
        [Benchmark(Description = "DuckDB: Multi-Col (Mat)")]
        ...
        [Benchmark(Description = "LF: Multi-Col (Mat)")]
